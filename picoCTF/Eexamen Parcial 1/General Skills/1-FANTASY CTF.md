...
Play this short game to get familiar with terminal applications and some of the most important rules in scope for picoCTF.Connect to the program with netcat:`$ nc verbal-sleep.picoctf.net 61356`
## Solución
```
Jose323-picoctf@webshell:~$ nc verbal-sleep.picoctf.net 61356
